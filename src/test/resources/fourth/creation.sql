...
insert into suppliers (company_name, first_name, last_name, fathers_name, bank_account_number, phone, fax, price, method) values
                                                                                                                              ('My company', 'John', 'Doe', 'Ivanovich', 1234321, '+380661234561', '+380621231231', 123, 2),
...
insert into supplies (type, mark, delay_time, price) VALUES
                                                         (1, 'bmw', 1, 2),
                                                         (2, 'bentley', 1, 2),
                                                         (3, 'gucci', 1, 2),
                                                         (4, 'balenciaga', 1, 2),
...
insert into suppliers_supplies (supplier_id, supply_id) VALUES
                                                            (2, 1),
                                                            (2, 2),
                                                            (2, 3),
                                                            (3, 4),
...
update suppliers set bank_account_number = 312312 where company_name LIKE 'My company';
